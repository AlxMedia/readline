	...
	$(document).ready(function($){
		...
		$('#btn-mode').on('click',function(e){
			...
			if ( 'light' == cur_mode ) {
				...
				$( "#readline-scheme-css" ).attr( "href", readlineObject.template_directory_uri + "/dark.css" );
			}
			else if ( 'dark' == cur_mode ) {
				// Switch to light.
				Cookies.set( 'theme_mode' , 'light' );
				$( "#readline-scheme-css" ).attr( "href", readlineObject.template_directory_uri + "/light.css" );
			}
		});
